...
export const users = [
  ...
  },
  {
    ...
    team: "Development",
    status: "not_done", // Changed status
    age: "25",
    ...
    switch (columnKey) {
      ...
      case "status":
        return user.status === "complete" ? (
          ...
          <Button size="sm" color="primary" endContent={<GenerateIcon />}>
            Generate
          </Button>
        );
      case "actions":
        return (
          <div className="relative flex items-center justify-center gap-2">
            <Tooltip
              content={
                user.status === "complete" ? "View Report" : "Generate Report"
              }
            >
              <span className="text-lg text-default-400 cursor-pointer active:opacity-50">
                {user.status === "complete" ? <EyeIcon /> : <EditIcon />}
              </span>
            </Tooltip>
